            ...
            <div class="flex flex-col justify-between p-6 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 shadow-sm">
                <div>
                    <div class="flex items-center gap-2 text-neutral-500 dark:text-neutral-400">
                        ...
                        <span class="text-xs font-semibold uppercase tracking-wider">Pendaftaran</span>
                    </div>
                    <h3 class="mt-3 text-lg font-bold text-neutral-900 dark:text-white">Daftar Program Kursus</h3>
                    <p class="mt-2 text-sm text-neutral-500 dark:text-neutral-400">
                        Pilih dan ikuti program kursus robotika terbaik untuk mengasah keterampilanmu.
                    </p>
                </div>
                <div class="mt-6">
                    <flux:button href="/daftar" variant="primary" class="w-full justify-center">
                        Daftar Sekarang
                    </flux:button>
                </div>
            </div>
