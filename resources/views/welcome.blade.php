...
<section id="program" class="py-24 px-6 sm:px-8 lg:px-16 bg-slate-50">
    ...
    <div class="flex justify-center mb-12">
        ...
        <div class="grid md:grid-cols-2 xl:grid-cols-4 gap-8">
            ...
            <!-- CARD 1 -->
        <div
            class="program-card bg-white rounded-[32px] border border-slate-200 overflow-hidden shadow-sm hover:shadow-2xl hover:shadow-cyan-500/10 hover:-translate-y-2 transition-all duration-300"
            data-category="online">
                ...
                <div class="bg-[#0b3553] p-8 relative overflow-hidden">
                    ...
                    <div class="flex justify-between mb-10">
                        ...
                        <span
                            class="bg-slate-500 text-white text-xs font-semibold px-3 py-1 rounded-full">
                            Pemula
                        </span>
                    </div>
...
<section class="py-20 px-6 bg-slate-50 min-h-screen">
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded-3xl p-10 shadow-sm border border-slate-200 mb-10">
            ...
            <span
                class="bg-cyan-100 text-cyan-700 text-xs font-bold px-3 py-1 rounded-full">
                Program Kursus
            </span>
            ...
            <p class="text-slate-500 leading-relaxed">
                ...
                @if ($program == 'arduino')
                    Pelajari dasar mikrokontroler Arduino mulai dari pemrograman, penggunaan sensor, hingga pembuatan mini project robotika.

                @elseif ($program == 'iot')
                    Pelajari pengembangan Internet of Things (IoT) menggunakan ESP32, komunikasi data, dan pembuatan sistem monitoring berbasis internet.

                @elseif ($program == 'ros')
                    Pelajari Robot Operating System (ROS) untuk membangun robot cerdas, simulasi robot, dan sistem navigasi otomatis.

                @elseif ($program == 'elektronika')
                    Pelajari konsep elektronika dasar, komponen elektronik, dan perancangan rangkaian sederhana sebagai fondasi robotika.
        ...
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-3xl p-8 border border-slate-200">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <span class="text-slate-600">
                            Memiliki motivasi belajar dan mampu mengikuti pembelajaran secara mandiri maupun berkelompok.
                        </span>
                    </div>
            ...
            <div>
                ...
                <div
                    class="bg-white rounded-3xl p-8 border border-slate-200 sticky top-24">
